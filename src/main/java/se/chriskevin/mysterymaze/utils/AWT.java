...
public class AWT {
    ...
    public static final class Dimension {
        ...
        public static java.awt.Dimension of(final se.chriskevin.mysterymaze.geometry.Dimension dimension) {
            return new java.awt.Dimension(dimension.width.intValue(), dimension.height.intValue());
        }

        public static se.chriskevin.mysterymaze.geometry.Dimension of(final java.awt.Dimension dimension) {
    ...
    public static final class Rectangle {
        public static java.awt.Rectangle of(final int x, final int y, final int width, final int height) {
            return new java.awt.Rectangle(x, y, width, height);
        }

        public static java.awt.Rectangle of(final Point3D point3D, final se.chriskevin.mysterymaze.geometry.Dimension dimension) {
