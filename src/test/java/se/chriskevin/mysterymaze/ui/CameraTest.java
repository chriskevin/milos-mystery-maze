...
public class CameraTest {
  ...
  public void verifyGetVisibleSprites() {
    ...
    final List<GameSprite> unfilteredSprites =
        List.of(
            GameSprite.of(
                null, 1L, false, ZERO_POINT3D, 0L, null, false, null, HashMap.empty(), null, size),
            GameSprite.of(
                null,
                1L,
                false,
                Point3D.of(400L, 400L, 0L),
                0L,
                null,
                false,
                null,
    ...
    final List<GameSprite> result =
        getVisibleSprites(unfilteredSprites, new Rectangle(0, 0, 300, 200));
